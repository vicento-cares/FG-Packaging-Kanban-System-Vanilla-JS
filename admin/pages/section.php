...
include('plugins/css/section_stylesheet.php');
include('plugins/preloader.php');
include('plugins/navbar.php');
include('plugins/sidebar/section_bar.php');
?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="section.php">Miscellaneous</a></li>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row mb-4">
          ...
          <div class="col-sm-2">
            <button type="button" class="btn bg-lightblue btn-block" onclick="load_data(3)"><i class="fas fa-search"></i> Search Section</button>
          </div>
          <div class="col-sm-2">
            <button type="button" class="btn bg-lightblue btn-block" onclick="load_data(1)"><i class="fas fa-sync-alt"></i> Refresh Table</button>
          </div>
          <div class="col-sm-2">
            <button type="button" class="btn bg-lightblue btn-block" data-toggle="modal" data-target="#AddSectionModal"><i class="fas fa-plus-circle"></i> Add Section</button>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="card card-lightblue card-outline">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-map-marker-alt"></i> Section Table</h3>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive" style="max-height: 400px; overflow: auto; display:inline-block;">
                  <table id="sectionTable" class="table table-head-fixed text-nowrap table-hover">
                    ...
                    <tbody id="sectionData" style="text-align: center;">
                      <tr>
...
include('plugins/modals/section_add.php');
include('plugins/modals/section_details.php');
include('plugins/modals/delete-data_modal.php');
include('plugins/js/section_script.php');
?>
