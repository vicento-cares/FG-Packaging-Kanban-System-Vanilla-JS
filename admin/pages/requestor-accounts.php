...
include('plugins/css/requestor-accounts_stylesheet.php');
include('plugins/preloader.php');
include('plugins/navbar.php');
include('plugins/sidebar/requestor-accounts_bar.php');
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Requestor/PIC Accounts</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="requested-packaging-materials.php">FG Packaging</a></li>
              <li class="breadcrumb-item"><a href="requestor-accounts.php">Account Management</a></li>
              <li class="breadcrumb-item active">Requestors</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row mb-4">
          ...
          <div class="col-sm-2">
            <button type="button" class="btn bg-lightblue btn-block" data-toggle="modal" data-target="#AddRAccountModal"><i class="fas fa-plus-circle"></i> Add Account</button>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12">
            <div class="card card-lightblue card-outline">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-users-cog"></i> Requestor Accounts Table</h3>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive" style="max-height: 400px; overflow: auto; display:inline-block;">
                  <table id="requestorAccountTable" class="table table-head-fixed text-nowrap table-hover">
                    ...
                    <tbody id="requestorAccountData" style="text-align: center;">
                      <tr>
...
include('plugins/modals/requestor-accounts_add.php');
include('plugins/modals/requestor-accounts_details.php');
include('plugins/modals/delete-data_modal.php');
include('plugins/js/requestor-accounts_script.php');
?>
