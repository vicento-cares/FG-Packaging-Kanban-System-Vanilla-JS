...
const get_details = el => {
  ...
  var supplier_name = el.dataset.supplier_name;

  document.getElementById("u_id").value = id;
  document.getElementById("u_supplier_name").value = supplier_name;
}
  ...
  xhr.onreadystatechange = () => {
    if (xhr.readyState === XMLHttpRequest.DONE) {
      ...
      if (xhr.readyState == 4 && (xhr.status >= 200 && xhr.status < 400)) {
        ...
        let table_rows = parseInt(document.getElementById("suppliersData").childNodes.length);
...
const load_data = option => {
  ...
  switch (option) {
    case 2:
      var id = document.getElementById("suppliersData").lastChild.getAttribute("id");
  ...
  if (continue_loading == true) {
    ...
    switch (option) {
      ...
      case 3:
        ...
        document.getElementById("suppliersData").innerHTML = loading;
        break;
      default:
    }
    xhr.onreadystatechange = () => {
      if (xhr.readyState === XMLHttpRequest.DONE) {
        ...
        if (xhr.readyState == 4 && (xhr.status >= 200 && xhr.status < 400)) {
          switch (option) {
            case 1:
              document.getElementById("suppliersData").innerHTML = response;
            ...
            case 2:
            case 4:
              document.getElementById("suppliersData").insertAdjacentHTML('beforeend', response);
...
$("#AddSuppliersModal").on('hidden.bs.modal', e => {
  document.getElementById("i_supplier_name").value = '';
});

const clear_suppliers_info_fields = () => {
  document.getElementById("u_id").value = '';
  document.getElementById("u_supplier_name").value = '';
}

const save_data = () => {
  var supplier_name = document.getElementById("i_supplier_name").value.trim();
  let xhr = new XMLHttpRequest();
  let url = "../../process/admin/suppliers_processor.php", type = "POST";
  var data = serialize({
    method: 'save_data',
...
const update_data = () => {
  ...
  var supplier_name = document.getElementById("u_supplier_name").value.trim();
  let xhr = new XMLHttpRequest();
  let url = "../../process/admin/suppliers_processor.php", type = "POST";
  var data = serialize({
    method: 'update_data',
