...
include('plugins/css/history_stylesheet.php');
include('plugins/preloader.php');
include('plugins/navbar/history_navbar.php');
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="row mb-2 ml-1 mr-1">
        <div class="col-sm-6">
          <h1 class="m-0"> Section History</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="request.php">FG Packaging</a></li>
            <li class="breadcrumb-item"><a href="history-section.php">Requestor</a></li>
          ...
          <div class="card card-lightblue card-outline">
            ...
            <div class="card-body">
              <div class="row mb-2">
                ...
                <div class="col-sm-3">
                  <label>Export</label>
                  <button type="button" class="btn bg-lightblue btn-block" id="btnExportStoreOutRequestHistoryCsv" onclick="export_store_out_request_history_section(0)" disabled><i class="fas fa-file-download"></i> Export CSV</button>
                </div>
              </div>
              <div class="row mb-2">
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                  <label>Search</label>
                  <button type="button" class="btn bg-lightblue btn-block" onclick="get_store_out_request_history_section(1)"><i class="fas fa-search"></i> Search History</button>
                </div>
                <div class="col-sm-3">
                  <label>Export</label>
                  <button type="button" class="btn bg-lightblue btn-block" id="btnExportWithRemarks" onclick="export_store_out_request_history_section(1)" disabled><i class="fas fa-file-download"></i> Export With Remarks</button>
                </div>
              </div>
              ...
              <div class="d-flex justify-content-sm-center">
                <button type="button" class="btn bg-lightblue" id="search_more_data" style="display:none;" onclick="get_store_out_request_history_section(2)">Load more</button>
              </div>
            </div>
            <!-- /.card-body -->
          </div>
