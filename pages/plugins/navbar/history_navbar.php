...
<nav class="main-header navbar navbar-expand-md navbar-dark bg-lightblue text-light border-bottom-0">
  ...
  <div class="collapse navbar-collapse order-3" id="navbarCollapse">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a href="request.php" class="nav-link"><i class="fas fa-archive"></i> Request Packaging Materials</a>
      </li>
      <li class="nav-item">
        <a href="history-section.php" class="nav-link active"><i class="fas fa-history"></i> History</a>
      </li>
      <li class="nav-item">
